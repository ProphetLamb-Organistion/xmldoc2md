...
#region Fields
        ...
        [field: NonSerialized]
        private bool _synchronizeSettings = false;
...
#region Public members
        ...
        {
            FrameworkAssemblyPaths = this.FrameworkAssemblyPaths, 
            FrameworkAssemblyNameHashes = this.FrameworkAssemblyNameHashes
        };
...
#region Private members
        ...
        private static void LoadSettings(ref Settings obj)
        {
            ...
            deserialized.FrameworkAssemblyNameHashes = Utility.AssemblyHashDumper.AssemblyNameHashes(deserialized
                   .FrameworkAssemblyPaths
                   .Where(Directory.Exists)
                   .SelectMany(d => Glob.Files(d, s_globDlls)), Console.WriteLine)
               .ToArray();
            obj = deserialized;
